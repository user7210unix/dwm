...
static const char *fonts[]          = { "Literation Mono Nerd Font:pixelsize=16:antialias=true:autohint=true" };
/* Background and foreground color definitions */
static const char col_bg1[]       = "#141414"; // Background color 2: Normal window borders
static const char col_bg2[]       = "#ffffff";
static const char col_bg3[]       = "#8c8c8c"; // Foreground for normal windows (unfocused)
static const char col_fg1[]       = "#1c1c1c"; // Foreground for selected windows (focused)
static const char col_acc[]       = "#000000"; // Accent color for selected window borders
...
static const char *alttags[] = { "I", "II", "III", "IV" };
...
static const char *roficmd[] = { "bash", "~/.config/rofi/launchers/type-2/launcher.sh", NULL }; 
